...
class ParameterSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // Format:
        // [batchNo, ambientTemp, humidity, soilTemp, soilMoisture, light(uv/led duration), pechayCount, actualDays]
        $dataset = [
            [1, 20.30, 40.50, 20.20, 40.20, 30.00, 15, 2.29],
            [2, 20.20, 40.30, 20.10, 40.10, 30.00, 14, 2.14],
            [3, 20.30, 40.40, 20.30, 40.40, 30.00, 15, 3.05],
            [4, 20.40, 40.30, 20.20, 40.20, 30.00, 16, 2.23],
            [5, 20.20, 40.30, 20.10, 39.70, 30.00, 14, 2.17],

            [6, 23.20, 45.30, 23.10, 45.10, 60.00, 16, 2.22],
            [7, 23.30, 45.50, 23.20, 45.30, 60.00, 17, 2.32],
            [8, 23.10, 45.80, 23.10, 44.80, 60.00, 18, 3.15],
            [9, 23.20, 45.30, 23.30, 45.20, 60.00, 18, 2.10],
            [10, 23.30, 45.60, 23.20, 45.40, 60.00, 17, 2.30],

            [11, 25.20, 50.70, 26.20, 50.20, 90.00, 20, 2.43],
            [12, 25.10, 50.30, 26.10, 50.50, 90.00, 21, 2.15],
            [13, 25.30, 50.50, 26.10, 49.80, 90.00, 22, 2.32],
            [14, 25.20, 50.70, 26.30, 50.10, 90.00, 20, 2.22],
            [15, 25.10, 50.60, 26.20, 50.30, 90.00, 21, 2.11],

            [16, 28.10, 55.50, 28.10, 55.40, 120.00, 22, 3.12],
            [17, 28.20, 55.30, 28.20, 55.20, 120.00, 23, 2.14],
            ...
            [22, 30.10, 60.30, 30.10, 59.80, 150.00, 25, 2.27],
            [23, 30.30, 60.10, 30.10, 60.10, 150.00, 24, 2.10],
            [24, 30.20, 60.60, 30.20, 60.50, 150.00, 23, 2.40],
            [25, 30.10, 60.40, 30.10, 60.20, 150.00, 24, 2.22],

            [26, 25.20, 50.70, 26.20, 50.20, 90.00, 21, 2.32],
            [27, 25.10, 50.30, 26.10, 50.50, 90.00, 20, 3.22],
            [28, 25.30, 50.50, 26.10, 49.80, 90.00, 22, 2.11],
            [29, 25.20, 50.70, 26.30, 50.10, 90.00, 21, 2.33],
            [30, 25.10, 50.60, 26.20, 50.30, 90.00, 21, 2.29],
        ];
        ...
        foreach ($dataset as $row) {
            ...
            for ($hourOffset = 0; $hourOffset < $totalHours; $hourOffset += 12) {
                ...
                Parameter::create([
                    ...
                    'Pechay_Count'        => ($hourOffset + 12 >= $totalHours) ? $row[6] : 0,
                    'Batch'               => $batchName,
